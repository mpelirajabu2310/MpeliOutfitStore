...
INSERT INTO `categories` (`id`, `name`, `description`, `created_at`) VALUES ('1', 'General', NULL, '2026-07-24 19:39:11');
...
INSERT INTO `expenses` (`id`, `category`, `expense_name`, `description`, `amount`, `expense_date`, `created_by`, `created_at`) VALUES ('1', 'Food', NULL, 'E2E test expense', '5000.00', '2026-07-24', '1', '2026-07-24 19:39:11');
...
INSERT INTO `product_variants` (`id`, `product_id`, `size_id`, `color_id`, `barcode`, `stock_quantity`, `reorder_level`, `created_at`, `updated_at`) VALUES ('1', '1', NULL, NULL, NULL, '10', '5', '2026-07-24 19:39:11', '2026-07-24 19:39:11');
INSERT INTO `product_variants` (`id`, `product_id`, `size_id`, `color_id`, `barcode`, `stock_quantity`, `reorder_level`, `created_at`, `updated_at`) VALUES ('2', '2', NULL, NULL, NULL, '20', '5', '2026-07-24 19:39:11', '2026-07-24 19:39:11');
...
INSERT INTO `products` (`id`, `category_id`, `product_name`, `buying_price`, `selling_price`, `minimum_allowed_selling_price`, `status`, `created_by`, `created_at`, `updated_at`) VALUES ('1', '1', 'Classic Suit', '25000.00', '45000.00', '30000.00', 'active', '1', '2026-07-24 19:39:11', '2026-07-24 19:39:11');
INSERT INTO `products` (`id`, `category_id`, `product_name`, `buying_price`, `selling_price`, `minimum_allowed_selling_price`, `status`, `created_by`, `created_at`, `updated_at`) VALUES ('2', '1', 'Summer Dress', '15000.00', '30000.00', '18000.00', 'active', '1', '2026-07-24 19:39:11', '2026-07-24 19:39:11');
...
INSERT INTO `shop_settings` (`id`, `shop_name`, `logo_url`, `address`, `phone`, `email`, `currency_code`, `low_stock_threshold`, `dark_mode_enabled`, `receipt_footer`, `created_at`, `updated_at`) VALUES ('1', 'Mpeli Outfit Store', NULL, NULL, NULL, NULL, 'TSH', '5', '0', NULL, '2026-07-24 19:39:11', '2026-07-24 19:39:11');
...
INSERT INTO `users` (`id`, `name`, `username`, `email`, `password_hash`, `role`, `status`, `last_login_at`, `created_at`, `updated_at`) VALUES ('1', 'System Admin', 'mpeli', 'admin@test.com', '$2y$10$XdvZovqqFIGyi5Rm6AJ1fukxEwLqeooSrU4Ulgzd3HBxL5PIjByhm', 'OWNER', 'active', '2026-07-24 19:39:11', '2026-07-24 19:39:10', '2026-07-24 19:39:11');
INSERT INTO `users` (`id`, `name`, `username`, `email`, `password_hash`, `role`, `status`, `last_login_at`, `created_at`, `updated_at`) VALUES ('2', 'Ikramu', 'Ikramu', 'ikramu@test.com', '$2y$10$.8ccaCo6FLKb16d6JeIbKOW/PKYIprZ3ToEgGZnK59UlpSPCWmbLS', 'SELLER', 'active', NULL, '2026-07-24 19:39:11', '2026-07-24 19:39:11');
